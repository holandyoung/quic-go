...
import (
	...
	"github.com/holandyoung/quic-go/qlogwriter/jsontext"
)
...
// -ldflags="-X github.com/holandyoung/quic-go/qlogwriter.quicGoVersion=foobar"
...
func init() {
	...
	for _, d := range info.Deps {
		if d.Path == "github.com/holandyoung/quic-go" {
