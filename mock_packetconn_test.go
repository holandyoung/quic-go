...
//
//	mockgen -typed -package quic -self_package github.com/holandyoung/quic-go -self_package github.com/holandyoung/quic-go -destination mock_packetconn_test.go net PacketConn
//
